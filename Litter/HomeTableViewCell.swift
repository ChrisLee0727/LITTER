...
class HomeTableViewCell: UITableViewCell {
    ...
    func updateView() {
        ...
        captionLabel.hashtagLinkTapHandler = { label, string, range in
            let tag = String(string.dropFirst()) //            let tag = String(string.characters.dropFirst())
    ...
    func setupUserInfo() {
      ...
      override func awakeFromNib() {
        ...
        let tapGestureForProfileImage =
            UITapGestureRecognizer(target: self, action: #selector(self.profileImageView_TouchUpInside))
        profileImageView.addGestureRecognizer(tapGestureForProfileImage)
        profileImageView.isUserInteractionEnabled = true
        
//        let longtapForLikeImage = UILongPressGestureRecognizer(target: self, action: #selector(self.likeImageView_longTouch))
//        likeImageView.addGestureRecognizer(longtapForLikeImage)
//        likeImageView.isUserInteractionEnabled = true
        
        let tapGestureForPostImage = UITapGestureRecognizer(target: self, action: #selector(self.postImageView_TouchUpInside))
        postImageView.addGestureRecognizer(tapGestureForPostImage)
...
//    @objc func likeImageView_longTouch() {
//        print("long")
//        Api.Post.decrementLikes(postId: post!.id!, onSuccess: { (post) in
...
//
//                guard let postLiked = post.isLiked else {
//                    return
//                }
//                if postLiked {
